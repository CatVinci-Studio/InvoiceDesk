 ...
 *
 * Mirrors the window config in src-tauri/tauri.conf.json (macOS:
 * `titleBarStyle: "Overlay"`) and src-tauri/tauri.windows.conf.json
 * (Windows: `decorations: false`); the two must agree, or the window either
 * loses its close button or grows a second one.
 */
